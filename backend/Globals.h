...
struct Settings {
    int ATARI_THREAT_SCORE = 500'000;
    int ATARI_COUNT_MULTIPLIER = 10;
    int MIN_LIB_1_MULTIPLIER = 1'000;
    int MIN_LIB_2_MULTIPLIER = 100;
    int MIN_LIB_3_MULTIPLIER = 50;
    int MIN_LIB_4_MULTIPLIER = 20;
    int TOTAL_LIB_MULTIPLIER = 0;
    int UNIQUE_LIB_MULTIPLIER = 10;
